  ...
  try {
    ...
    if (!apiKey || 
      ...
      return res.status(400).json({
        error: "Missing API Key! Please configure either GOOGLE_API_KEY or GEMINI_API_KEY in your deployment environment variables (Vercel project settings) to activate the chatbot support."
      });
    }
